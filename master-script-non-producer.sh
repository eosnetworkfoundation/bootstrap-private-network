...
SNAPSHOT=“”
# Install Spring
curl -L --output /local/eosnetworkfoundation/antelope-spring_1.0.0_amd64.deb https://github.com/AntelopeIO/spring/releases/download/v1.0.0/antelope-spring_1.0.0_amd64.deb 2> /dev/null
mkdir /local/eosnetworkfoundation/spring
dpkg -x /local/eosnetworkfoundation/antelope-spring_1.0.0_amd64.deb /local/eosnetworkfoundation/spring
